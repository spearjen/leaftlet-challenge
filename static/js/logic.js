...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_month.geojson", function(infoMag) {
    ...
    // Loop through the earthquake properties (they're the same size and have partially matching data)
    for (var i = 0; i < earthquakeMag.length; i++) {

        // Create a new earthquake object with properties of both station objects
        var earthquake = Object.assign({}, earthquakeMag[i], earthquakeGeo[i]);
...
function updateLegend(earthquakeCount) {
  document.querySelector(".legend").innerHTML = [
    ...
    "<p class='depthShallow'>Number of uakes 2.5 - 5 magnitude & Shallow: " + earthquakeCount.btTwoFiveFourNineShallow + "</p>",
